...
$res = array();
    ...
    $count_query = "SELECT COUNT(*) as total FROM zw_journal";
    ...
    $query = "SELECT * FROM zw_journal LIMIT $start, $limit";
    $con = dbCon();
...
<body>
    <div class="container col-md" style='padding:0% 3%;background:#fff;transform:none!important;margin-bottom: 20px;'>
        <div class="payment-received-container">
            <header class="header">
                ...
                <a href='add.php?type=journal' style='float:right;padding: 9px 16px;border-radius: 12px;color: #fff;font-weight: 600;background: #0f6b2b;' class="add-button">+ Add</a>
            </header>
            ...
            <table class="payments-table">
                <thead>
                    <tr>
                        ...
                        <th>
                            <div class="th-data">Journal# <span class="filter"><button class="arrow-up" onclick="sortTable(1, 'asc')">▲</button><button class="arrow-down" onclick="sortTable(1, 'desc')">▼</button></span></div>
                        </th>
                         <th>
                            <div class="th-data">Reference <span class="filter"><button class="arrow-up" onclick="sortTable(2, 'asc')">▲</button><button class="arrow-down" onclick="sortTable(2, 'desc')">▼</button></span></div>
                        </th>
                        <th>
                            <div class="th-data">Amount <span class="filter"><button class="arrow-up" onclick="sortTable(3, 'asc')">▲</button><button class="arrow-down" onclick="sortTable(3, 'desc')">▼</button></span></div>
                        </th>
                        <th></th>
                    </tr>
                </thead>
                <tbody class="payments-table-body">
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td><a href="view.php?type=chartaccount&id=<?php echo $row['id']; ?>" ><?php echo $row['title']; ?></a></td>
                            ...
                            <td><span class="more-options"
                                ...
                                <div class="popup-menu">
                                    ...
                                    <div class="popup-item delete"
                                        ><a class="i-tag" href="delete.php?id=<?php echo $row['id']; ?>&type=journal"><span
                                            class="material-symbols-outlined">
                                            delete
                                        </span></a>
                                        Delete</div>
        ...
        <footer class="footer">
            <div class="pagination">
                ...
                <a href="?t=journal&page=<?php echo ($page - 1); ?>&g=ac" class="pagination-button-prev <?php if ($page <= 1) : ?>disabled-link<?php endif; ?>"><span class="material-symbols-outlined">
                        arrow_back
                    </span></a>


                <a href="?t=journal&page=<?php echo ($page + 1); ?>&g=ac" class="pagination-button-next <?php if ($page >= $total_pages) : ?>disabled-link<?php endif; ?>">Next Page
    ...
    <script>
        ...
        function editRow(element) {
            location = "edit.php?id="+element+"&type=journal";
        }

        function deleteRow(element) {
        window.location.href = 'delete.php?type=journal&id=' + element;        
    }
    </script>
