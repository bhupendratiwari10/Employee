...
$res = array();
    ...
    $count_query = "SELECT COUNT(*) as total FROM zw_epr_po";
    ...
    $query = "SELECT * FROM zw_epr_po LIMIT $start, $limit";
    $con = dbCon();
...
<body>
    ...
    <div class="payment-received-container">
        <header class="header" style="margin-bottom: 42px;">
                ...
                <a href='add.php?type=orders' style='float:right;padding: 9px 16px;border-radius: 12px;color: #fff;font-weight: 600;background: #0f6b2b;' class="add-button">+ Add</a>
            </header>
            ...
            <table class="payments-table">
                <thead>
                    <tr>
                        ...
                        <th>
                            <div class="th-data">Order# <span class="filter"><button class="arrow-up" onclick="sortTable(1, 'asc')">▲</button><button class="arrow-down" onclick="sortTable(1, 'desc')">▼</button></span></div>
                        </th>
                         <th>
                            <div class="th-data">Customer <span class="filter"><button class="arrow-up" onclick="sortTable(2, 'asc')">▲</button><button class="arrow-down" onclick="sortTable(1, 'desc')">▼</button></span></div>
                        </th>
                ...
                <tbody class="payments-table-body">
                    ...
                    ?>
                        ...
                        <tr>
                            <td><?php echo date('d-m-Y', strtotime(substr($row['po_date'], 0, 10))); ?></td>
        ...
        <footer class="footer">
            <div class="pagination">
                ...
                <a href="?t=orders&g=epr&page=<?php echo ($page - 1); ?>" class="pagination-button-prev <?php if ($page <= 1) : ?>disabled-link<?php endif; ?>"><span class="material-symbols-outlined">
                        arrow_back
                    </span></a>


                <a href="?t=orders&g=epr&page=<?php echo ($page + 1); ?>" class="pagination-button-next <?php if ($page >= $total_pages) : ?>disabled-link<?php endif; ?>">Next Page
    ...
    <script>
        ...
        function editRow(element) {
            window.location.href = 'edit.php?type=orders&id=' + element;
        }

        function deleteRow(element) {
            if(confirm("Do You Really Want To Delete This Record?")){
             window.location.href = 'delete.php?type=orders&id=' + element;
