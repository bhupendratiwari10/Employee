...
$res = array();
    ...
    $count_query = "SELECT COUNT(*) as total FROM zw_ulb";
    ...
    $query = "SELECT * FROM zw_ulb LIMIT $start, $limit";
    $con = dbCon();
...
<body>
    <div class="container col-md" style='padding:0% 3%;background:#fff;transform:none!important;margin-bottom: 20px;'>
        <div class="payment-received-container">
            <header class="header">
                ...
                <a href='add.php?type=ulbs' style='float:right;padding: 9px 16px;border-radius: 12px;color: #fff;font-weight: 600;background: #0f6b2b;' class="add-button">+ Add</a>
            </header>
            ...
            <table class="payments-table">
                <thead>
                    <tr>
                        <th>
                            <div class="th-data">
                                ULB(Title) <span class="filter"><button class="arrow-up" onclick="sortTable(0, 'asc')">▲</button><button class="arrow-down" onclick="sortTable(0, 'desc')">▼</button></span>
                            </div>
                        </th>
                        <th>
                            <div class="th-data">District<span class="filter"><button class="arrow-up" onclick="sortTable(1, 'asc')">▲</button><button class="arrow-down" onclick="sortTable(1, 'desc')">▼</button></span></div>
                        </th>
                         <th>
                            <div class="th-data">State <span class="filter"><button class="arrow-up" onclick="sortTable(2, 'asc')">▲</button><button class="arrow-down" onclick="sortTable(2, 'desc')">▼</button></span></div>
                        </th>
                        <th>
                            <div class="th-data">Monthly Waste Generation <span class="filter"><button class="arrow-up" onclick="sortTable(3, 'asc')">▲</button><button class="arrow-down" onclick="sortTable(3, 'desc')">▼</button></span></div>
                        </th>
                ...
                <tbody class="payments-table-body">
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td><?php echo $row['monthly_waste']; ?></td>
                            <td><span class="more-options"
                                ...
                                <div class="popup-menu">
                                    ...
                                    <div class="popup-item delete"
                                        ><a class="i-tag" href="delete.php?id=<?php echo $row['id']; ?>&type=ulbs"><span
                                            class="material-symbols-outlined">
                                            delete
                                        </span></a>
                                        Delete</div>
        ...
        <footer class="footer">
            <div class="pagination">
                ...
                <a href="?t=ulbs&page=<?php echo ($page - 1); ?>&g=epr" class="pagination-button-prev <?php if ($page <= 1) : ?>disabled-link<?php endif; ?>"><span class="material-symbols-outlined">
                        arrow_back
                    </span></a>


                <a href="?t=ulbs&page=<?php echo ($page + 1); ?>&g=epr" class="pagination-button-next <?php if ($page >= $total_pages) : ?>disabled-link<?php endif; ?>">Next Page
    ...
    <script>
        ...
        function editRow(element) {
            location = "edit.php?id="+element+"&type=ulbs";
        }

        function deleteRow(element) {
        window.location.href = 'delete.php?type=ulbs&id=' + element;        
    }
