...
$res = array();
    ...
    $count_query = "SELECT COUNT(*) as total FROM zw_company";
    ...
    $query = "SELECT * FROM zw_company LIMIT $start, $limit";
    $con = dbCon();
...
<body>
    ...
    <div class="payment-received-container">
        <header class="header" style="margin-bottom: 42px;">
                ...
                <a href='add.php?type=company' style='float:right;padding: 9px 16px;border-radius: 12px;color: #fff;font-weight: 600;background: #0f6b2b;' class="add-button">+ Add</a>
            </header>
            ...
            <table class="payments-table">
                <thead>
                    <tr>
                        ...
                        <th>
                            <div class="th-data">
                                Vendor <span class="filter"><button class="arrow-up" onclick="sortTable(0, 'asc')">▲</button><button class="arrow-down" onclick="sortTable(0, 'desc')">▼</button></span>
                            </div>
                        </th>
                        <th>
                            <div class="th-data">Email <span class="filter"><button class="arrow-up" onclick="sortTable(1, 'asc')">▲</button><button class="arrow-down" onclick="sortTable(1, 'desc')">▼</button></span></div>
                        </th>
                        <th>
                            <div class="th-data">Phone <span class="filter"><button class="arrow-up" onclick="sortTable(2, 'asc')">▲</button><button class="arrow-down" onclick="sortTable(2, 'desc')">▼</button></span></div>
                        </th>
                        <th>
                            <div class="th-data">Recievables <span class="filter"><button class="arrow-up" onclick="sortTable(3, 'asc')">▲</button><button class="arrow-down" onclick="sortTable(3, 'desc')">▼</button></span></div>
                        </th>
                ...
                <tbody class="payments-table-body">
                    ...
                    ?>
                        ...
                        <tr>
                            <td><img src="<?php echo $row['pfp']; ?>" style="width:45px;border:0.6px solid #ddd;border-radius:1000px;aspect-ratio:1/1;object-fit:contain;"></td>
                            <td> <?php echo $row['vendor_display_name']; ?></td>
        ...
        <footer class="footer">
            <div class="pagination">
                ...
                <a href="?t=company&g=prc&page=<?php echo ($page - 1); ?>" class="pagination-button-prev <?php if ($page <= 1) : ?>disabled-link<?php endif; ?>"><span class="material-symbols-outlined">
                        arrow_back
                    </span></a>


                <a href="?t=company&g=prc&page=<?php echo ($page + 1); ?>" class="pagination-button-next <?php if ($page >= $total_pages) : ?>disabled-link<?php endif; ?>">Next Page
    ...
    <script>
        ...
        function editRow(element) {
            window.location.href = 'edit.php?type=company&id=' + element;
        }

        function deleteRow(element) {
            if(confirm("Do You Really Want To Delete This Record?")){
             window.location.href = 'delete.php?type=company&id=' + element;
