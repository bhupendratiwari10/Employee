...
$res = array();
    ...
    $count_query = "SELECT COUNT(*) as total FROM zw_invoices";
    ...
    $query = "SELECT * FROM zw_invoices LIMIT $start, $limit";
    $con = dbCon();
...
<body>
    ...
    <div class="payment-received-container">
        <header class="header" style="margin-bottom: 42px;">
                ...
                <a href='add.php?type=invoice' style='float:right;padding: 9px 16px;border-radius: 12px;color: #fff;font-weight: 600;background: #0f6b2b;' class="add-button">+ Add</a>
            </header>
            ...
            <table class="payments-table">
                ...
                <tbody class="payments-table-body">
                    ...
                    ?>
                        ...
                        <tr>
                            <td><?php echo date('d-m-Y', strtotime(substr($row['invoice_date'], 0, 10))); ?></td>

                            <td><a href="print.php?type=invoice&id=<?php echo $row['id']; ?>">#ZW-IN-<?php echo $row['id']; ?></a></td>
                            <td> <?php echo $row['customer_name']; ?></td>
                            <td><?php echo $row['due_date']; ?></td>
                            <td><?php echo ($row['status']==1) ? 'Unpaid' : 'Paid' ?></td>
    ...
    <script>
        ...
        function editRow(element) {
            window.location.href = 'edit.php?type=invoice&id=' + element;
        }

        function deleteRow(element) {
            if(confirm("Do You Really Want To Delete This Record?")){
             window.location.href = 'delete.php?type=invoice&id=' + element;
