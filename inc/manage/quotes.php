...
$page = isset($_GET['page']) ? intval($_GET['page']) : 1; // Current page (sanitized)
$page = max(1, $page); // Ensure page is at least 1
$start = ($page - 1) * $limit; // Offset

// Count total number of rows (for pagination)
$count_query = "SELECT COUNT(*) as total FROM zw_Quote";
...
$query = "SELECT * FROM zw_Quote ORDER BY id DESC LIMIT $start, $limit";
...
<body>
    <div class="container col-md" style='padding:0% 3%;background:#fff;transform:none!important;'>
        <div class="payment-received-container">
            <header class="header" style="margin-bottom: 42px;">
                ...
                <a href='add.php?type=quote' style='float:right;padding: 9px 16px;border-radius: 12px;color: #fff;font-weight: 600;background: #0f6b2b;' class="add-button">+ Add</a>
            </header>
                ...
                <table class="payments-table">
                    <thead>
                        <tr>
                            ...
                            <th>
                                <div class="th-data">Quote # <span class="filter"><button class="arrow-up" onclick="sortTable(1, 'asc')">▲</button><button class="arrow-down" onclick="sortTable(1, 'desc')">▼</button></span></div>
                            </th>
                            <th>
                    ...
                    <tbody class="payments-table-body">
                        ...
                        if ($res && mysqli_num_rows($res) > 0) {
                            while ($row = mysqli_fetch_assoc($res)) {
                                $customer_name = namebyAid($row['customer_id'], "customer_display_name", "zw_customers");
                        ...
                        ?>
                            <tr>
                                ...
                                <td><a href="print.php?type=quote&id=<?php echo $row['id']; ?>">#Quote-<?php echo str_pad($row['id'], 5, '0', STR_PAD_LEFT); ?></a></td>
                        ...
                        <?php 
                            ...
                            echo '<tr><td colspan="5" style="text-align:center;">No quotes found</td></tr>';
                        }
                        ?>
                    </tbody>
                </table>
            ...
            <footer class="footer">
                <div class="pagination">
                    <a href="?t=quote&g=sls&page=<?php echo ($page - 1); ?>" class="pagination-button-prev <?php if ($page <= 1) : ?>disabled-link<?php endif; ?>">
                        <span class="material-symbols-outlined">arrow_back</span>
                    </a>
                    <a href="?t=quote&g=sls&page=<?php echo ($page + 1); ?>" class="pagination-button-next <?php if ($page >= $total_pages) : ?>disabled-link<?php endif; ?>">
    ...
    <script>
        ...
        function editRow(id) {
            window.location.href = 'edit.php?type=quote&id=' + id;
        }

        function deleteRow(id) {
            if(confirm("Do You Really Want To Delete This Record?")) {
                window.location.href = 'delete.php?type=quote&id=' + id;
            }
        }
        ...
        function goToPage(pageNum) {
            ...
            if (pageNum >= 1 && pageNum <= <?php echo $total_pages; ?>) {
                window.location.href = '?t=quote&g=sls&page=' + pageNum;
            }
        }
    </script>
</body>
