...
$res = array();
    ...
    $count_query = "SELECT COUNT(*) as total FROM zw_items";
    ...
    $query = "SELECT * FROM zw_items LIMIT $start, $limit";
    $con = dbCon();
...
<body>
    ...
    <div class="payment-received-container">
        <header class="header" style="margin-bottom: 42px;">
                ...
                <a href='add.php?type=items' style='float:right;padding: 9px 16px;border-radius: 12px;color: #fff;font-weight: 600;background: #0f6b2b;' class="add-button">+ Add</a>
            </header>
            ...
            <table class="payments-table">
                <thead>
                    <tr>
                        <th>
                            <div class="th-data">
                                Item <span class="filter"><button class="arrow-up" onclick="sortTable(0, 'asc')">▲</button><button class="arrow-down" onclick="sortTable(0, 'desc')">▼</button></span>
                            </div>
                        </th>
                        <th>
                            <div class="th-data">Description <span class="filter"><button class="arrow-up" onclick="sortTable(1, 'asc')">▲</button><button class="arrow-down" onclick="sortTable(1, 'desc')">▼</button></span></div>
                        </th>
                         <th>
                            <div class="th-data">Unit <span class="filter"><button class="arrow-up" onclick="sortTable(1, 'asc')">▲</button><button class="arrow-down" onclick="sortTable(1, 'desc')">▼</button></span></div>
                        </th>
                        <th>
                            <div class="th-data">Rate <span class="filter"><button class="arrow-up" onclick="sortTable(3, 'asc')">▲</button><button class="arrow-down" onclick="sortTable(3, 'desc')">▼</button></span></div>
                        </th>
                ...
                <tbody class="payments-table-body">
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td><?php echo $row['selling_price_description']; ?></td>
        ...
        <footer class="footer">
            <div class="pagination">
                ...
                <a href="?t=items&page=<?php echo ($page - 1); ?>" class="pagination-button-prev <?php if ($page <= 1) : ?>disabled-link<?php endif; ?>"><span class="material-symbols-outlined">
                        arrow_back
                    </span></a>


                <a href="?t=items&page=<?php echo ($page + 1); ?>" class="pagination-button-next <?php if ($page >= $total_pages) : ?>disabled-link<?php endif; ?>">Next Page
    ...
    <script>
        ...
        function editRow(element) {
            window.location.href = 'edit.php?type=items&id=' + element;
        }

        function deleteRow(element) {
            if(confirm("Do You Really Want To Delete This Record?")){
             window.location.href = 'delete.php?type=items&id=' + element;
