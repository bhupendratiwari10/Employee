...
$res = array();
    ...
    $count_query = "SELECT COUNT(*) as total FROM zw_pickups";
    ...
    $query = "SELECT * FROM zw_pickups LIMIT $start, $limit";
    $con = dbCon();
...
<body>
    <div class="container col-md" style='padding:0% 3%;background:#fff;transform:none!important;margin-bottom: 20px;'>
        <div class="payment-received-container">
            <header class="header">
                ...
                <a href='add.php?type=pickups' style='float:right;padding: 9px 16px;border-radius: 12px;color: #fff;font-weight: 600;background: #0f6b2b;' class="add-button">+ Add</a>
            </header>
            ...
            <table class="payments-table">
                <thead>
                    <tr>
                        <th>
                            <div class="th-data">
                                Pickup Date <span class="filter"><button class="arrow-up" onclick="sortTable(0, 'asc')">▲</button><button class="arrow-down" onclick="sortTable(0, 'desc')">▼</button></span>
                            </div>
                        </th>
                        <th>
                            <div class="th-data">Title <span class="filter"><button class="arrow-up" onclick="sortTable(1, 'asc')">▲</button><button class="arrow-down" onclick="sortTable(1, 'desc')">▼</button></span></div>
                        </th>
                         <th>
                            <div class="th-data">ULB <span class="filter"><button class="arrow-up" onclick="sortTable(2, 'asc')">▲</button><button class="arrow-down" onclick="sortTable(2, 'desc')">▼</button></span></div>
                        </th>
                        <th>
                            <div class="th-data">State <span class="filter"><button class="arrow-up" onclick="sortTable(3, 'asc')">▲</button><button class="arrow-down" onclick="sortTable(3, 'desc')">▼</button></span></div>
                        </th>
                        <th>
                            <div class="th-data">Supervisor <span class="filter"><button class="arrow-up" onclick="sortTable(4, 'asc')">▲</button><button class="arrow-down" onclick="sortTable(4, 'desc')">▼</button></span></div>
                        </th>
                        <th></th>
                    </tr>
                </thead>
                <tbody class="payments-table-body">
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td><a href="view.php?type=pickups&id=<?php echo $row['id']; ?>" >ZW-PK-00<?php echo $row['id']; ?></a></td>
                            <td><?php echo $row['ulbname']; ?> </td>
                            ...
                            <td><span class="more-options"
                                ...
                                <div class="popup-menu">
                                    ...
                                    <div class="popup-item delete"
                                        ><a class="i-tag" href="delete.php?id=<?php echo $row['id']; ?>&type=pickups"><span
                                            class="material-symbols-outlined">
                                            delete
                                        </span></a>
                                        Delete</div>
                                ...
                                <?php if($row['steps'] <= 7){ ?>
                                <button class="completeOrder" data-id="<?php echo $row['id']; ?>" title='Complete Order'><i class='mi-ic_fluent_play_circle_24_filled'></i></button>
                            <?php } ?>
                            </td>
                        </tr>
                    <?php } ?>
        ...
        <footer class="footer">
            <div class="pagination">
                ...
                <a href="?t=pickups&page=<?php echo ($page - 1); ?>&g=epr" class="pagination-button-prev <?php if ($page <= 1) : ?>disabled-link<?php endif; ?>"><span class="material-symbols-outlined">
                        arrow_back
                    </span></a>


                <a href="?t=pickups&page=<?php echo ($page + 1); ?>&g=epr" class="pagination-button-next <?php if ($page >= $total_pages) : ?>disabled-link<?php endif; ?>">Next Page
    ...
    <script>
        ...
        function editRow(element) {
            location = "edit.php?id="+element+"&type=pickups";
        }

        function deleteRow(element) {
        window.location.href = 'delete.php?type=pickups&id=' + element;        
    }

    $('.payments-table').on('click', '.completeOrder', function() {
