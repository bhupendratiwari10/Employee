...
$sqlItems = "SELECT * FROM zw_Bill_items WHERE bill_id = $uid";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $deleteItemsQuery = "DELETE FROM zw_Bill_items WHERE bill_id = $uid";
    ...
    $file = uploadImage("bill_receipt", "uploads/bill_receipt"); if(!empty($file)){$suba = "file_src = '$file', ";}else{$suba='';}
    ...
    for ($i = 0; $i < count($itemIds); $i++) {
        ...
        $sqlItems = "INSERT INTO zw_Bill_items (bill_id, item_name, item_account, quantity, rate, discount)
                VALUES ('$uid', '$itemName', '$itAcc', '$quantity', '$rate', '$discount')";
    ...
    if($succ==1){ alert("Bill Updated successfully."); redirect("manage.php?t=bill&g=prc");}
}
?>
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            <input type='date' class='form-control' name='invoice_date' id='invoice_date' value="<?php echo $res['bill_date']; ?>" required>
                        </div>
                        ...
                        <div class="col-sm-2">
                            <input type='date' class='form-control' id="due_date" name='due_date'  value="<?php echo $res['due_date']; ?>"required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
		                    <input type='email' class='form-control'  value="<?php echo $res['mail_to']; ?>" name='mail_to' required>
		                </div>
                    </div>
                    ...
                    <div class="col-sm-12 mt-5 p-0">
                        ...
                        <table class="table table-bordered table_row" width="100%">
                            ...
                            <tr>
                                <td width= '37%'><input type="text" class="col-md-12" name="item_id[]" placeholder="Item Name" value="<?php echo $resItmes['item_name']; ?>"> </td>
                                <td width= '17%'><select class="col-md-12" style='background-color:#fff!important;' name="item_account[]">
                                    <?php acOptionsAdv('bills',$resItmes['item_account']); ?>
                                </select> </td>
                                <td width= '10%'><input type="text" class="col-md-12 quantity" name="quantity[]" placeholder="Quantity" value="<?php echo $resItmes['quantity']; ?>" required></td>
                                
                                <td width= '10%'><input type="text" class="col-md-12 rate" name="rate[]" placeholder="Rate" value="<?php echo $resItmes['rate']; ?>" required></td>
                                <td width= '10%'><input type="number" class="col-md-12 gst" onfocusout="validateInput(this)" name="gst[]" value="<?php echo $resItmes['gst']; ?>" placeholder="GST"></td>
                                <td width= '10%'><input type="text" class="col-md-12 discount" name="discount[]" placeholder="IN (INR)" value="<?php echo $resItmes['discount']; ?>" required></td>
                                
                                <td class="lineItemAmount" width= '10%'>>0.0</td>
...
<script>
    ...
    $(document).ready(function() {
        ...
        function addNewRow() {
          var newRow = $('.table_row:last').clone();
