...
$id = $_GET['id']; $query = "SELECT * FROM zw_invoices WHERE id='$id' LIMIT 1";  $result = mysqli_query($con, $query);
...
echo"
    ...
    <div class='col-12 row' style='margin-top:5%; padding:2vh 5vw;padding-bottom:8vh'>
        ...
        <div class='col-md-9' style='margin-bottom:26px;'>
            ...
            <h5><b style='color:#555;'>P.O. :</b> #ZW-000R-".$row['p_o']."</h5>
        ...
        $queriy = "SELECT * FROM zw_invoice_items WHERE invoice_id='$id'";  $resulit = mysqli_query($con, $queriy); $nn = 0; $tt = 0;
