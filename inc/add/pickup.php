...
<form method="post" action="" enctype="multipart/form-data" id="multi-page-form">
  <div class="row g-3 page">
    ...
    <div class="col-md-6">
      <select class='form-select' name='po' id='po' required>
    ...
    <div class="col-md-6">
      <select class='form-select' name='ulb' id="ulb" required>
    ...
    <div class="col-md-6">
      <select class='form-select' name='supervisor'>
        ...
        <?php hitQuery("SELECT id , first_name from zw_user WHERE user_role = 3", "id", "first_name"); ?>
      </select>
    </div>
    ...
    <div class="col-md-6">
      <input class="form-control" type="text" name="state" placeholder="State" id="state" readonly required>
    </div>
  ...
  <div class="page">
    ...
    <div class="buttons mt-5">
      <button class="btn btn-primary prev-page">Previous</button>
      <button class="btn btn-primary next-page" data-step="8" data-type="submit">Submit</button>
    </div>
  </div>
...
<script>
  ...
  $("#ulb").change(function() {
    let ulbValue = $(this).val();
    let state = $('#state');
    console.log(ulbValue);
    $.ajax({
      url: "inc/ajax.php",
      type: "POST",
      data: {
      ...
      success: function(result) {
        result = result.trim(); // Corrected: invoking trim() method
        state.val(result);
      }
    });
  })
