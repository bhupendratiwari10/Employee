...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sqlInvoice = "INSERT INTO zw_Quote (customer_id, subject, quote_date, subTotal, terms, sales_person, remarks, toc, mail_to)
            VALUES ('$customer_id', '$subject', '$invoice_date', '$subTotal', '$terms', '$sales_person', '$remarks', '$toc', '$mail_to')";
...
?>
    ...
    <form method="post" class="row" action="">
        <div class='mt-5 col-md-12 row'>
            <span class="col-2" for="customer_id">Select Customer</span>
            <select id="customer_id" class='col-6' name="customer_id" required>
                <option value="" disabled selected>Select Customer</option>
                <?php optionPrintAdv("zw_customers WHERE customer_type!='ulb'","id","customer_display_name"); ?>
            </select>
        </div>
        <div class='mt-3 col-md-12 row'>
            <span class="col-2" for="subject">Subject</span>
            <input type='text' class="col-6" name='subject' required>
        </div>
        <div class='mt-3 col-md-12 row'>
            <span class="col-2 pr-0 mr-0" for="invoice_date">Quote Date</span>
            <input type='date' class="col-6" style="border:1px solid gray;background:#dbdbdb;padding:11px 21px;margin:0;" name='invoice_date' required>
        </div>
        <!--<div class='col-md-3'>-->
       ...
       <div class='col-md-12 mt-3 row'>
            <span class="col-2" for="mail_to">Mail To (BCC Email)</span>
            <input type='email' class='col-6' name='mail_to'>
        </div>
        <div class='col-md-12 mt-2 row'>
            <span class="col-2" for="sales_person">Select Salesperson</span>
            <select id="sales_person" class='col-6' name="sales_person">
                <option value="0" disabled selected>Select Salesperson</option>
