...
<script>
   ...
   $('#customer_id').change(function() {
      ...
      $.ajax({
        type: 'GET',
        url: 'https://zwindia.in/sub/epr/record.php?fun=search_po', // Replace with your API endpoint
  ...
  $(document).ready(function() {
    ...
    $.ajax({
        type: 'GET',
        url: 'https://zwindia.in/sub/epr/record.php?fun=get_invoice_id',
        success: function(response) {
          // Handle the success response
   ...
   var currentRow;
    ...
    $('#date_confirmed').click(function() {
      ...
      $.ajax({
        type: 'GET',
        url: 'https://zwindia.in/sub/epr/record.php?fun=get_qty', // Replace with your API endpoint
