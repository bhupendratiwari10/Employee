...
<form method="post" action="" enctype="multipart/form-data" id="multi-page-form">
  <div class="row g-3 page">
    ...
    <div class="col-md-6">
      <input class="form-control date" type="date" name="pickup_date" placeholder="Pickup Date" required>
    </div>
    ...
    <div class="col-md-6">
      <input class="form-control" type="text" name="truck_registration_number" placeholder="Truck Registration Number" required>
    </div>
   ...
   <div class="page">
    ...
    <div class="col-md-12">
      <div class="row">
        ...
        <input type="file" class="form-control-file image_upload_section" id="loaded_truck_picture" accept="image/*, .pdf" name="loaded_truck_picture" required>
        <div class="file-preview">
        ...
        <div class="col-md-6">
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label for="input2">Date</label>
                <input type="date" class="form-control date" id="loaded_truck_picture_date" name="loaded_truck_picture_date" required>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label for="input3">Time</label>
                <input type="time" class="form-control" id="loaded_truck_picture_time" name="loaded_truck_picture_time" required>
              </div>
            </div>
          </div>
        </div>
   ...
   <div class="page">
    ...
    <div class="col-md-12">
      <div class="row">
        ...
        <input type="file" class="form-control-file image_upload_section" id="bridge_certificate_loaded" accept="image/*, .pdf" name="loaded_weigh_bridge_certificate_picture" required>
        <div class="file-preview">
        ...
        <div class="col-md-6">
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label for="input2">Date</label>
                <input type="date" class="form-control date" id="bridge_date_loaded" name="loaded_weigh_bridge_certificate_date" required>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label for="input3">Time</label>
                <input type="time" class="form-control" id="bridge_time_loaded" name="loaded_weigh_bridge_certificate_time" required>
              </div>
            </div>
             <div class="col-md-6">
              <div class="form-group">
                <label for="input3">Net Quantity</label>
                <input type="number" class="form-control" id="bridge_time_loaded_netQuantity" name="net_quantity" required>
              </div>
            </div>
          </div>
        </div>
   ...
   <div class="page">
    ...
    <div class="col-md-12">
      <div class="row">
        ...
        <input type="file" class="form-control-file image_upload_section" id="truck_receipt" accept="image/*, .pdf" name="truck_receipt" required>
        <div class="file-preview">
        ...
        <div class="col-md-6">
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label for="input2">Date</label>
                <input type="date" class="form-control date" id="truck_receipt_date" name="truck_receipt_date" required>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label for="input3">Time</label>
                <input type="time" class="form-control" id="truck_receipt_time" name="truck_receipt_time" required>
              </div>
            </div>
          </div>
        </div>
...
Certificate</label>
        <input type="file" class="form-control-file image_upload_section" id="recycling_certificate" accept="image/*, .pdf" name="recycling_certificate_picture" required>
        <div class="file-preview">
        ...
        <div class="col-md-6">
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label for="input2">Date</label>
                <input type="date" class="form-control date" id="recycling_certificate_date" name="recycling_certificate_date" required>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label for="input3">Time</label>
                <input type="time" class="form-control" id="recycling_certificate_time" name="recycling_certificate_time" required>
              </div>
            </div>
          </div>
        </div>
  ...
  <div class="page">
    ...
    <div class="col-md-12">
      <div class="row">
        ...
        <input type="file" class="form-control-file image_upload_section" id="ulb_endorsement_copy" accept="image/*, .pdf" name="ulb_endorsement_copy" required>
        <div class="file-preview">
        ...
        <div class="col-md-6">
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label for="input2">Date</label>
                <input type="date" class="form-control date" id="ulb_endorsement_copy_date" name="ulb_endorsement_copy_date" required>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label for="input3">Time</label>
                <input type="time" class="form-control" id="ulb_endorsement_copy_time" name="ulb_endorsement_copy_time" required>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class = "buttons mt-5" >
           <button class="btn btn-primary prev-page">Previous</button>
            <button class="btn btn-primary next-page" type="button" data-type = 'submit' data-step="8">Submit</button>
   </div>
  </div>
...
//   console.log('currentPage' , currentPage );
  ...
  $nextButtons.on("click", function (e) {
   ...
   console.log('length' , $pages.length , 'currentPage' , currentPage);
...
console.log(selectedFile);
    if (selectedFile) {
      ...
      // Reset Cropper.js instance if already initialized
     if (cropper) {
		cropper.destroy();
	    }
	  ...
	  if(index==0 || index == 3 || index == 4){
          ...
          cropper = new Cropper(imagePreview, {
            ...
            viewMode: 0, // Set the cropping box to cover the whole preview area
            autoCropArea: 0, // Automatically crop the entire image
            crop: function(event) {
		    ...
		    viewMode: 1, // Set the cropping box to cover the whole preview area
		    ...
		    aspectRatio: 1/1.41, // Set your desired aspect ratio
		    viewMode: 0, // Set the cropping box to cover the whole preview area
		    autoCropArea: 0, // Automatically crop the entire image
		    crop: function(event) {
		      // Get cropped canvas data
 ...
 function applyCircularMask(canvas) {
    ...
    ctx.drawImage(canvas, radius - canvas.width / 2, radius - canvas.height / 2);
   ...
   const steps = parseInt($(this).data('step'));
    ...
    $.ajax({
        ...
        success: function (result) {
            console.log(steps);
            // Check if it's the last step before redirecting
                if (steps === 8) {
