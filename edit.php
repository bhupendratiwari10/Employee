...
<head>
    ...
    <title>Edit <?php echo $_GET['type']; ?></title>
...
echo "<div class='container col-md-10' style='padding:5% 3%;background:#fff;border-radius:21px;margin-top:1%;transform:scale(0.96);font-size:84%;color:#333;'>";
...
if($type == 'user') {
   ...
   include('inc/edit/expense.php');
    ...
    include('inc/edit/account.php');
 } elseif ($type == 'categories') {
    include('inc/edit/category.php');
 } elseif ($type == 'company') {
 ...
 } elseif($type == 'journals' || $type == 'journal'){
   include('inc/edit/journal.php');
 } elseif($type == 'quote'){
   ...
   include('inc/edit/eprinvoice.php');
 }
 elseif($type == 'pickups'){
   include('inc/edit/pickup.php');
 }
?>