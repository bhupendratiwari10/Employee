...
checklogin(); 
// Don't call updateAccounts() here - it needs jQuery
?>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <!-- Move jQuery to head to ensure it loads first -->
...
<body class='row'>
    ...
    <div class="container col-md" style='padding:5% 3%;background:#f3f3f3;transform:none!important;'>
        <?php include('inc/views/dash_fin.php'); ?>
    </div>
    
  
    
    <!-- Call updateAccounts after jQuery is loaded -->
    <script>
    $(document).ready(function() {
        // Now jQuery is loaded, we can call PHP functions that use jQuery
        <?php updateAccounts(); ?>
    });
    </script>
</body>
